...
// The judgements this component makes about an upload -- how large a photo may be for this
// uploader, and whether a failure is worth retrying. Pure, and tested in tests/upload-policy.test.ts.
// What happens to the photo itself before it uploads is lib/upload/image-pipeline.
import {
  maxImageDimFor,
...
import { detectKind, uploadCapsForTier, tooLargeMessage, generateVideoPoster, ALLOWED_IMAGE_TYPES, ALLOWED_VIDEO_TYPES } from '@/lib/media'
import {
...
// ─── The photo pipeline, handed this browser ────────────────────────────────
// Every decision about a photo before it uploads -- kept as shot or re-encoded, location removed,
// shrunk, HEIC converted, the <img> last resort -- is lib/upload/image-pipeline, tested and mutated
// there. What stays in this file is the browser those decisions run against.
