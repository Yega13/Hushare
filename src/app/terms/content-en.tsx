...
// English is the BINDING version of the terms; the translations say so and link here.
//
// Bodies lifted verbatim from terms/page.tsx when the page became multilingual, so the published
// English did not change. Ids are new — the sections were numbered but had no anchors, so nothing
// could link to a specific clause. They are generated from the English headings and must stay
...
export const en: TermsContent = {
  ...
  },
  {
    ...
    heading: 'Who is responsible for an album',
    body: (
      <>
          <p>
  ...
  },
  {
    ...
    heading: 'Logos and sponsor branding',
    body: (
      <>
          <p>
  ...
  },
  {
    ...
    heading: 'Album links and passwords',
    body: (
      <>
          <p>
  ...
  },
  {
    ...
    heading: 'Our rights to remove content',
    body: (
      <>
          <p>
  ...
  },
  {
    ...
    heading: 'DMCA and intellectual property',
    body: (
      <>
          <p>
