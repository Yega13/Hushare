 ...
 *
 * The attack it also closes was claimed fixed and was not: capping context.repeats at 1000 does
 * nothing when the threshold is 8. Eight posts with eight distinct messages reach it with nothing
 * to cap, fire the alert, and burn the whole hour for every real incident behind them. Keying the
