...
export default {
  ...
  { name: 'THE OFFSCREEN ENCODER IS NEVER TRIED, so every photo pays for the DOM canvas path',
    from: "offscreen: typeof OffscreenCanvas !== 'undefined' ? offscreenSurface : null,", to: "offscreen: null," },
