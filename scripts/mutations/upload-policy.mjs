...
export default {
  ...
  { name: 'A DELETED OR EXPIRED ALBUM GOES BACK TO BEING A FAULT in the Errors tab',
    from: "  ALBUM_UNAVAILABLE,\n", to: "" },
  { name: 'the album-unavailable words are retyped instead of imported',
    from: "  ALBUM_UNAVAILABLE,", to: "  'This album is not available'," },
