...
export default {
  ...
  { name: 'the collector never records a skipped row (the report can never fire)',
    from: "        if (row) skipped.push({ id: row.id, storage_backend: row.storage_backend, storage_path: row.storage_path, thumb_url: row.thumb_url, poster_url: row.poster_url, stream_uid: row.stream_uid })",
    to:   "        void row" },
  { name: 'a skipped row loses its paths (only the id, which the cascade deletes)',
    from: "storage_path: row.storage_path, thumb_url: row.thumb_url, poster_url: row.poster_url, stream_uid: row.stream_uid })",
    to:   "storage_path: null, thumb_url: null, poster_url: null, stream_uid: null })" },
